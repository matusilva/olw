                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-8 gap-4 flex flex-row items-end">
                        ...
                        <div class="col-span-4 lg:col-span-2">
                            ...
                            <a @click.prevent="downloadFile" class=" cursor-pointer ml-4 inline-flex items-center px-4 py-2 bg-blue-800 border border-transparent rounded-md font-semibold text-white">
                                Download
                            </a>
                        </div>
                    </div>
